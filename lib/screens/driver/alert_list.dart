...
class DriverAlertList extends StatefulWidget {
  const DriverAlertList({super.key});

  @override
  State<DriverAlertList> createState() => _DriverAlertListState();
}

class _DriverAlertListState extends State<DriverAlertList> {
  var filterValue = 1;
  String deviceSearch = '';
