...
class ContainerUserScreen extends StatefulWidget {
  const ContainerUserScreen({super.key});

  @override
  State<ContainerUserScreen> createState() => _ContainerUserScreenState();
}

class _ContainerUserScreenState extends State<ContainerUserScreen> {
  static const List<Widget> _widgetOptions = <Widget>[
    HomeUserScreen(),
    VechicleUserListScreen(),
    InsuranceUserList(),
    Text(
      'Service',
    ),
